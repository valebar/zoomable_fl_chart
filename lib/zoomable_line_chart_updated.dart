...
class ZoomableLineChartUpdated extends StatefulWidget {
  final double minX;
  final double maxX;
  final double minY;
  final double maxY;
  ...
  const ZoomableLineChartUpdated({
    super.key,
    required this.minX,
    required this.maxX,
    required this.minY,
  ...
  @override
  State<ZoomableLineChartUpdated> createState() => _ChartState();
}

class _ChartState extends State<ZoomableLineChartUpdated> {
